            ...
            <div className="relative w-full h-full flex items-center justify-center">
                ...
                <AnimatePresence>
                    {step === 2 && (
                        ...
                        >
                            <div className="bg-[#0a0a0a] border border-white/10 p-10 rounded-[2.5rem] shadow-2xl w-80 text-center relative overflow-hidden group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="inline-flex items-center gap-3 px-6 py-3 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-emerald-400 text-xs font-black uppercase tracking-widest mb-12 transition-transform group-hover:scale-110">
